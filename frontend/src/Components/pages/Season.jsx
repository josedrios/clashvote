    ...
    <div className="comment-section">
      <div className="comments-container">
        ...
        {comments.slice(0, 1).map(([username, comment], index) => (
          <Comment username={username} comment={comment} key={index} />
        ))}
        <div className="create-comment">
          ...
          <div className="create-comment-actions">
            <button className="cancel-comment-btn standard-btn">Cancel</button>
            <button className="create-comment-btn standard-btn">Comment</button>
          </div>
        </div>
      </div>
    </div>
